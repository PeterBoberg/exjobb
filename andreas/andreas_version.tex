...
\begin{document}
	...
	The purpose of the project is to examine the possibility of creating an application that uses the accelerometer in a mobile phone to detect a falling accident and report it to registered contacts using SMS.
