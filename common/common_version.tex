...
\begin{document}
	...
	\begin{enumerate}
		...
		\item Walk 10 m while holding the phone close to the trouser pocket, and drop the phone from a height of 1 m
		\item Run 10 m while carrying the phone in the trouser pocket, and stand still for 5 s afterwards
		\item Walk 10 m while carrying the phone in the trouser pocket, and stand still for 5 s afterwards
		\item Jump with the phone in the trouser pocket, and stand still for 5 s afterwards
	\end{enumerate}
...
\subsection{Application user interface}
	...
	\subsubsection{Falling  from 1 m (simulate falling while standing on the ground)}
	...
	\subsubsection{Falling from 1.5 m (simulate falling from  for e.g. a chair)}
	...
	\subsubsection{Falling from 3 m (simulate falling from for e.g a ladder)}
	...
	The overall results show that there exists some differences between the application running on an iOS device and its Android counterpart. For each device, we can calculate the overall success rate by the following equation in \ref{equation:overall-success}
