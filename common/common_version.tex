...
\subsection{Application user interface}
	...
	Neither Abbate et al. or Yildirim et al. does any measurements on battery consumption, although it is mentioned that accelerometer update frequency has an impact om battery in their thesis's. We, on the other hand, did a rudimentary evaluation of battery consumption.
